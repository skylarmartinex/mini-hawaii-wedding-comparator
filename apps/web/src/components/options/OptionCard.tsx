...
import type { WeddingOption } from "@wedding/shared";
import { OPTION_TYPES, type OptionTypeKey, formatCostRange, useCompareStore, useOptionStore } from "@wedding/shared";
...
export function OptionCard({ option, viewMode = "grid", onEdit }: OptionCardProps) {
  ...
  const cycleStatus = () => {
    const statuses: Array<keyof typeof import("@wedding/shared").STATUSES> = ["RESEARCHING", "SHORTLISTED", "FINALIST", "ELIMINATED"];
